    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <ul class="list-unstyled footer-blog-list">
                    <li class="d-flex align-items-center">
                        ...
                        <div class="text">
                            <h5 class="mb-0">
                                <a href="../pages/post.php">Blog post name</a>
                            </h5>
                        </div>
                    </li>
                    <li class="d-flex align-items-center">
                    ...
                    <li class="d-flex align-items-center">
                        ...
                        <div class="text">
                            <h5 class="mb-0">
                                <a href="../pages/post.php">Very very long blog post name</a>
                            </h5>
                        </div>
                    </li>
                </ul>
            ...
            <div class="col-lg-3">
                ...
                <a href="contact.php" class="btn btn-template-main">Go to contact page</a>
                <hr class="d-block d-lg-none" />
            </div>
            <div class="col-lg-3">
