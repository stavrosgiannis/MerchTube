...
$rechnungs_header = '
<img style="height:50px; width:120px;" src="../img/logo.png">
MerchTube
Stavros Giannis
www.merchtube.de';

$rechnungs_empfaenger = print_r ($anwender->vorname).' '.print_r ($anwender->nachname).'
'.print_r ($anwender->telefon).'
'.print_r ($anwender->rechnungsanschriftliste[0]->strasse).'
'.print_r ($anwender->rechnungsanschriftliste[0]->plz).' '.print_r ($anwender->rechnungsanschriftliste[0]->stadt);
